...
addEventHandler("onResourceStart", getRootElement(),
	function (startedResource)
		if getResourceName(startedResource) == "sm_database" then
			connection = exports.sm_database:getConnection()
		elseif source == getResourceRootElement() then
			local sm_database = getResourceFromName("sm_database")

			if sm_database and getResourceState(sm_database) == "running" then
				connection = exports.sm_database:getConnection()
			end
