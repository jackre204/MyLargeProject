availableStations = {
	...
	[2] = {
		...
		pedDetails = {
			name = "Wardis D Cavan",
			skin = 299,
			position = {1907.0065917969, -1785.7504882812, 13.6015625},
			rotation = 0,
			interior = 0,
			dimension = 0
		},
		...
		outerColShape = {
			details = {1914.1927490234 - 10, -1797.1961669922, 42.518432617188, 39.71044921875}
		},
		innerColShape = {
			details = {1934.8016357422 - 18, -1785.1324462891, 10.962768554688, 15.44482421875}
		},
		priceTable = {
...
if localPlayer then
	...
	function addFuelPoint(stationId, x, y, z, rot)
		...
		fuelPoint.element = createObject(1686, x, y, z, 0, 0, 0 + rot)
	...
	addFuelPoint(2, 1920.0052490234 - 1, -1777.0286865234 + 0.1, 13.547775268555 + 0.5, 90)
	addFuelPoint(2, 1920.0052490234 + 6.6, -1777.0286865234 + 0.1, 13.547775268555 + 0.5, 90)

	addFuelPoint(2, 1920.0052490234 - 1, -1777.0286865234 - 13.8, 13.547775268555 + 0.5, 90)
	addFuelPoint(2, 1920.0052490234 + 6.6, -1777.0286865234 - 13.8, 13.547775268555 + 0.5, 90)
